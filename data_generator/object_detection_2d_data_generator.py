...
from ssd_keras_lib.ssd_input_encoder import SSDInputEncoder
    ...
    def parse_xml(self,
        ...
        for images_dir, image_set_filename, annotations_dir in zip(images_dirs, image_set_filenames, annotations_dirs):
            ...
            for image_id in it:
                ...
                subfolder, annotations_image_id = image_id.split('/')
                if not annotations_dir is None:
                    # Parse the XML file for this image.
                    with open(os.path.join(annotations_dir, annotations_image_id + '.xml')) as f:
